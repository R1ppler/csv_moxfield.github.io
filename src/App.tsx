...
                    <p className="text-gray-400 uppercase text-sm mt-1">{previewCard.set_name} ({previewCard.set.toUpperCase()}) #{previewCard.collector_number}</p>
                    <p className={`text-xl mt-2 font-mono font-bold flex items-center justify-center md:justify-start gap-1 ${isFoil ? 'text-purple-400' : 'text-orange-300'}`}>
